...
const { modify_quotePage } = require('../../page/purchasePage/modify_quotePage')
...
describe('V2_CREO_APL: 購買要件詳細/アクション：修正する/ Purchasing Requirements Details / Actions: Modify : purchase/modify_quote.js', async () => {
    const modify_quote = new modify_quotePage()
    ...
    beforeEach(async () => {
        ...
        await modify_quote.login_pass()
        await page.setViewportSize({ width: 1920, height: 1080 })
        
    })

    //=============Check display screen=========================================================
    it('TC81: Check click [ 修正する]  button', async () => {
        await modify_quote.detail_screen()
        let isDisplay = await modify_quote.display_modify_button()
    ...
    it('TC85_1: Check [見積依頼先担当] disable when not input [見積依頼先]', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
    ...
    it('TC85_2:  Check display popup [見積依頼先選択] ', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
    ...
    it('TC85_3: [見積依頼先担当] is enabled when input [見積依頼先]', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
        await purchase_register.click_get_request_quotation()
    ...
    it('TC86_1: Check [支払情報] will disable when not input [支払先]', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
    ...
    it('TC86_2: Check display pop up [支払先選択]', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
    ...
    it('TC86_3: Check [支払情報] enable when input [支払先] ', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
        await purchase_register.click_get_payment_destination()
    ...
    it('TC87_1: Check display popup [品目選択]', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
    ...
    //============Close popup [品目選択]===============================================================
    it('TC87_2: Close popup [品目選択]', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
        await purchase_register.click_get_item1()
    ...
    it('TC88: Update request_quotation', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
            await purchase_register.click_get_request_quotation()
            await purchase_register.select_random_value_department_popup()
    ...
    it('TC89: Updated content modify', async () => {
        await modify_quote.detail_screen()
        await modify_quote.click_modify()
            await purchase_register.click_get_request_quotation()
            await purchase_register.select_random_value_department_popup()

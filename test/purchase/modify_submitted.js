...
const { modify_submittedPage } = require('../../page/purchasePage/modify_submittedPage')
...
describe('V2_CREO_APL: 購買要件詳細/アクション：修正する（見積依頼申請済）/ Purchasing Requirement Details / Action: Modify (Quotation Request Submitted) : purchase/modify_submitted.js', async () => {
    const modify_submmitted = new modify_submittedPage()
    ...
    beforeEach(async () => {
        ...
        await modify_submmitted.login_pass()      
        await page.setViewportSize({ width: 1920, height: 1080 })
       
    })

    //=============Check display screen=========================================================
    it('TC47: Check click [削除する] button', async () => {
        await modify_submmitted.detail_screen()
        let isDisplay = await modify_submmitted.display_modify_button()
        await assert.strictEqual(isDisplay, true, "Modify button [修正する] is not enable : FAILED")
        if (isDisplay) {
            await console.log(" Modify submitted purchase screen display correct: PASSED")
        }
    })
    ...
    it('TC52: Check [見積依頼先担当] disable when not input [見積依頼先]', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
    ...
    it('TC52_1:  Check display popup [見積依頼先選択] ', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
    ...
    it('TC52_3: [見積依頼先担当] is enabled when input [見積依頼先]', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
        await purchase_register.click_get_request_quotation()
    ...
    it('TC53: Check [支払情報] will disable when not input [支払先]', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
    ...
    it('TC53: Check display pop up [支払先選択]', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
    ...
    it('TC53: Check [支払情報] enable when input [支払先] ', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
        await purchase_register.click_get_payment_destination()
    ...
    it('TC54: Check display popup [品目選択]', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
    ...
    //============Close popup [品目選択]===============================================================
    it('TC54: Close popup [品目選択]', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
        await purchase_register.click_get_item1()
    ...
    it('TC55: Update request_quotation', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
            await purchase_register.click_get_request_quotation()
            await purchase_register.select_random_value_department_popup()
    ...
    it('TC56: Updated content modify', async () => {
        await modify_submmitted.detail_screen()
        await modify_submmitted.click_modify()
            await purchase_register.click_get_request_quotation()
            await purchase_register.select_random_value_department_popup()

...
describe('V2_CREO_APL: 発注登録 / Order search : order/order_applied.js', async () => {
    ...
    it('TC157: Check display Order detail with 発注申請済 search', async () => {
    ...
    //==================Check error mess ========================================
    it('TC159: Check error mess when 発注予定日 < current day', async () => {
        await order_search.filter_status(locator.order_applied)
    ...
    it('TC160: Check error mess when 発注予定日 < 発注申請日', async () => {
        await order_search.filter_status(locator.order_applied)
        await order_search.click_modify_button()
    ...
    it('TC161: Check edit value 仕入先 in 発注申請済 detail', async () => {
        await order_search.filter_status(locator.order_applied)
        await order_search.click_modify_button()
    ...
    //========== Check [支払情報] is blank ================================================
    it('TC162: Check edit value 支払先', async () => {
        await order_search.filter_status(locator.order_applied)
        await order_search.click_modify_button()
    ...
    it('TC163: Check edit value 支払先 in 発注申請済 detail', async () => {
        await order_search.filter_status(locator.order_applied)
        await order_search.click_modify_button()
    ...
    it('TC163_1: Check calculator total value of [品目]', async () => {
        await order_search.filter_status(locator.order_applied)
    ...
    it('TC164: Check Click [ 修正する] button', async () => {
        await order_search.filter_status(locator.order_applied)
        await order_search.click_modify_button()
    ...
    it('TC165: Check update when Click [ 修正する] button and Click [ 閉じる ] button', async () => {
        await order_search.filter_status(locator.order_applied)
        await order_search.click_modify_button()

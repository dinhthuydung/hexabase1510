const { Locator } = require('../../locator/purchase/approve_quote.js')
...
class approve_quotePage extends WorkSpace {
    approve_requestPage() {}
    async login_pass() {
    ...
    async click_approve(){    
        ...
        if (enable){
            return base.click_element(locator.approve_button,"[ 購買見積依頼承認する ] button")
        }       
    } 
    ...
    async display_approve_button(){
        return base.check_display_element(locator.approve_button,"[ 購買見積依頼承認する ] button")
    }
...
module.exports = { approve_quotePage }
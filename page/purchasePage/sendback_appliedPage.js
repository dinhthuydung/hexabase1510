const { Locator } = require('../../locator/purchase/sendback_applied.js')
...
class sendback_appliedPage extends WorkSpace {
    sendback_appliedPage() {}
    async login_pass() {
...
module.exports = { sendback_appliedPage }